...
void mainImage(out vec4 o, vec2 C) {
  ...
  for (vec2 r = iResolution.xy, Q; ++i < ${Number(iterations).toFixed(1)}; O += o.w/d*o.xyz) {
...
export const Plasma: React.FC<PlasmaProps> = ({
  ...
  useEffect(() => {
    ...
    const directionUniform = program.uniforms.uDirection as { value: number }
    ...
    const loop = (t: number) => {
      ...
      if (direction === "pingpong") {
        ...
        directionUniform.value = 1.0;
        timeUniform.value = pingpongTime;
      } else {
